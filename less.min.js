    ...
    return function a(b, c, d) {
        ...
        1: [function(a, b) {
            ...
            b.exports = function(a, b) {
                ...
                void 0 === b.isFileProtocol && (b.isFileProtocol = /^(file|chrome(-extension)?|resource|qrc|app):/.test(a.location.protocol)),
                b.async = b.async || !1,
        ...
        6: [function(a, b) {
            b.exports = function(b, c) {
                ...
                g.prototype.doXHR = function(a, e, f, g) {
                    ...
                    i.send(null),
                    b.isFileProtocol && !b.fileAsync ? 0 === i.status || i.status >= 200 && i.status < 300 ? f(i.responseText) : g(i.status, a) : j ? i.onreadystatechange = function() {
        ...
        7: [function(a, b) {
            ...
            b.exports = function(e, f) {
                function g(a) {
                    return f.postProcessor && "function" == typeof f.postProcessor && (a = f.postProcessor.call(a, a) || a),
                    a
                }
                function h(a) {
                    var b = {};
                ...
                function j(a) {
                    for (var b, c = n.getElementsByTagName("style"), d = 0; d < c.length; d++)
                        ...
                        b.type.match(u)) {
                            ...
                            o.render(g, e, i(function(a, b, c) {
                                b ? s.add(b, "inline") : (a.type = "text/css",
                ...
                function k(a, b, g, i, j) {
                    function k(c) {
                        ...
                        if (k.entryPath = k.currentDirectory,
                        k.rootpath = l.rootpath || k.currentDirectory,
                        j) {
                            j.remaining = i;
                            var m = t.getCSS(h, j);
                            if (!g && m)
                                return d.createCSS(e.document, m, a),
                                j.local = !0,
                ...
                function m() {
                    "development" === o.env && (o.watchTimer = setInterval(function() {
                        o.watchMode && (r.clearFileCache(),
                        l(function(a, b, c, f, h) {
                            a ? s.add(a, a.href || f.href) : b && (b = g(b),
                ...
                return o.watch = function() {
                    return o.watchMode || (o.env = "development",
                    m()),
                    this.watchMode = !0,
                    !0
                }
                ,
                o.unwatch = function() {
                    return clearInterval(o.watchTimer),
                    this.watchMode = !1,
                    !1
                }
                ,
                o.registerStylesheets = function() {
                    return new Promise(function(a) {
                        ...
                        for (var c = 0; c < b.length; c++)
                            ("stylesheet/less" === b[c].rel || b[c].rel.match(/stylesheet/) && b[c].type.match(u)) && o.sheets.push(b[c]);
                        a()
                    }
                    )
                }
                ...
                o.refresh = function(a, b, c) {
                    return (a || c) && c !== !1 && r.clearFileCache(),
                    new Promise(function(c, f) {
                        var h, i, k;
                        h = i = new Date,
                        l(function(a, b, j, l, m) {
                            return a ? (s.add(a, a.href || l.href),
                            void f(a)) : (m.local ? o.logger.info("loading " + l.href + " from cache.") : (o.logger.info("rendered " + l.href + " successfully."),
                            b = g(b),
                            d.createCSS(e.document, b, l),
                            t.setCSS(l.href, m.lastModified, b)),
                            o.logger.info("css for " + l.href + " generated in " + (new Date - i) + "ms"),
                            0 === m.remaining && (k = new Date - h,
                            o.logger.info("less has finished. css generated in " + k + "ms"),
                            c({
                                startTime: h,
                                endTime: i,
                                totalMilliseconds: k,
            ...
            b.exports = {
                ...
                addDataAttr: function(a, b) {
                    for (var c in b.dataset)
                        b.dataset.hasOwnProperty(c) && (a[c] = "env" === c || "dumpLineNumbers" === c || "rootpath" === c || "errorReporting" === c ? b.dataset[c] : JSON.parse(b.dataset[c]))
                }
            }
        }
        , {}],
        ...
        15: [function(a, b) {
            ...
            c.prototype.getFileManager = function(a, b, c, d, e) {
                ...
                for (var g = f.length - 1; g >= 0; g--) {
                    var h = f[g];
                    if (h[e ? "supportsSync" : "supports"](a, b, c, d))
                        return h
                }
                return null
            }
        ...
        18: [function(a, b) {
            b.exports = function(b) {
                ...
                e.add("data-uri", function(a, e) {
                    ...
                    if (!p.contents)
                        return g.warn("Skipped data-uri embedding because file not found"),
                        f(this, e || a);
                    var q = p.contents
                      , r = 32
                      , s = parseInt(q.length / 1024, 10);
                    if (s >= r && this.context.ieCompat !== !1)
                        return g.warn("Skipped data-uri embedding of %s because its size (%dKB) exceeds IE8-safe %dKB!", i, s, r),
                        f(this, e || a);
        ...
        25: [function(a) {
            ...
            e.addMultiple({
                ...
                replace: function(a, c, d, e) {
                    var f = a.value;
                    return f = f.replace(new RegExp(c.value,e ? e.value : ""), d.value),
                    new b(a.quote || "",f,a.escaped)
                },
                "%": function(a) {
                    for (var c = Array.prototype.slice.call(arguments, 1), d = a.value, e = 0; e < c.length; e++)
        ...
        26: [function(a, b) {
            b.exports = function(b) {
                ...
                g.add("svg-gradient", function(a) {
                    ...
                    var h, i, j, k, l, m, n, o = Array.prototype.slice.call(arguments, 1), p = "linear", q = 'x="0" y="0" width="1" height="1"', r = !0, s = {
                        compress: !1
                    }, t = a.toCSS(s);
                    switch (t) {
                    case "to bottom":
                    ...
                    for (i = '<?xml version="1.0" ?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" viewBox="0 0 1 1" preserveAspectRatio="none"><' + p + 'Gradient id="gradient" gradientUnits="userSpaceOnUse" ' + h + ">",
                    j = 0; j < o.length; j += 1)
                        o[j].value ? (k = o[j].value[0],
                        l = o[j].value[1]) : (k = o[j],
                        l = void 0),
                        k instanceof d && ((0 === j || j + 1 === o.length) && void 0 === l || l instanceof c) || g(),
                        m = l ? l.toCSS(s) : 0 === j ? "0%" : "100%",
                        n = k.alpha,
                        i += '<stop offset="' + m + '" stop-color="' + k.toRGB() + '"' + (1 > n ? ' stop-opacity="' + n + '"' : "") + "/>";
                    if (i += "</" + p + "Gradient><rect " + q + ' fill="url(#gradient)" /></svg>',
                    r)
                        try {
                            i = b.encodeBase64(i)
                        } catch (u) {
                    ...
                    return i = "'data:image/svg+xml" + (r ? ";base64" : "") + "," + i + "'",
        ...
        27: [function(a) {
            ...
            i.addMultiple({
                ...
                unit: function(a, d) {
                    ...
                    return d = d ? d instanceof b ? d.value : d.toCSS() : "",
                    new c(a.value,d)
                },
                "get-unit": function(a) {
                    return new f(a.unit)
            ...
            b.exports = function(a) {
                ...
                return b.prototype.push = function(b, e, f, g, h) {
                    ...
                    var m = function(a) {
                        ...
                        k.relativeUrls && (k.rootpath = l.join(i.context.rootpath || "", l.pathDiff(k.currentDirectory, k.entryPath)),
                        !l.isPathAbsolute(k.rootpath) && l.alwaysMakePathsAbsolute() && (k.rootpath = l.join(k.entryPath, k.rootpath))),
                        k.filename = b;
                        var h = new c.Parse(i.context);
                        h.processImports = !1,
                        i.contents[b] = e,
                        (f.reference || g.reference) && (k.reference = !0),
                        g.inline ? j(null, e, b) : new d(h,i,k).parse(e, function(a, c) {
                            j(a, c, b)
                        })
                    }
            ...
            b.exports = function(a) {
                ...
                return b.prototype.toCSS = function(b) {
                    ...
                    try {
                        ...
                        b.sourceMap ? (f = new a(b.sourceMap),
                        g.css = f.toCSS(e, i, this.imports)) : g.css = e.toCSS(i)
                    } catch (h) {
                        throw new c(h,this.imports)
                    }
                    if (b.pluginManager)
                        for (var j = b.pluginManager.getPostProcessors(), k = 0; k < j.length; k++)
                    ...
                    for (var l in this.imports.files)
                        this.imports.files.hasOwnProperty(l) && l !== this.imports.rootFilename && g.imports.push(l);
                    return g
                }
                ,
                b
        ...
        34: [function(a, b) {
            ...
            b.exports = function() {
                ...
                k.$ = function(c) {
                    var d, e, f = typeof c;
                    return "string" === f ? b.charAt(k.i) !== c ? null : (t(1),
                    c) : (a(),
                    (d = c.exec(h)) ? (e = d[0].length,
                    t(e),
                    "string" == typeof d ? d : 1 === d.length ? d[0] : d) : null)
                }
                ,
                k.$re = function(a) {
                    k.i > i && (h = h.slice(k.i - i),
                    i = k.i);
                    var b = a.exec(h);
                    return b ? (t(b[0].length),
                    "string" == typeof b ? b : 1 === b.length ? b[0] : b) : null
                }
                ,
                k.$char = function(a) {
                    return b.charAt(k.i) !== a ? null : (t(1),
                    a)
                }
                ;
                var l = 32
                ...
                var t = function(a) {
                    for (var c, e, f, j = k.i, p = d, q = k.i - i, s = k.i + h.length - q, u = k.i += a, v = b; k.i < s; k.i++) {
                        if (c = v.charCodeAt(k.i),
                        k.autoCommentAbsorb && c === r) {
                            if (e = v.charAt(k.i + 1),
                            "/" === e) {
                                f = {
                                    index: k.i,
              ...
              , h = function i(a, b, h) {
                ...
                return {
                    parse: function(f, g, j) {
                        ...
                        (l || j && j.banner) && (p = (j && j.banner ? j.banner : "") + l,
                        ...
                        if (!r.isFinished) {
                            ...
                            s || (s = "Unrecognised input",
                            "}" === r.furthestChar ? s += ". Possibly missing opening '{'" : ")" === r.furthestChar ? s += ". Possibly missing opening '('" : r.furthestReachedEnd && (s += ". Possibly missing something")),
                            n = new c({
                                type: "Parse",
                                message: s,
                                index: r.furthest,
                    ...
                    parsers: n = {
                        ...
                        entities: {
                            ...
                            call: function() {
                                ...
                                if (!o.peek(/^url\(/i))
                                    ...
                                    b = a.toLowerCase(),
                                    "alpha" === b && (e = n.alpha()) ? e : (c = this.arguments(),
                                    o.$char(")") ? (o.forget(),
                            ...
                            assignment: function() {
                                ...
                                return a = o.$re(/^\w+(?=\s?=)/i),
                                a && o.$char("=") ? (b = n.entity(),
                                b ? new d.Assignment(a,b) : void 0) : void 0
                            },
                            url: function() {
                                var a, b = o.i;
                                return o.autoCommentAbsorb = !1,
                                "u" === o.currentChar() && o.$re(/^url\(/) ? (a = this.quoted() || this.variable() || o.$re(/^(?:(?:\\[\(\)'"])|[^\(\)'"])+/) || "",
                        ...
                        mixin: {
                            ...
                            args: function(a) {
                                ...
                                for (o.save(); ; ) {
                                    ...
                                    g = h;
                                    var q = null;
                                    if (a ? h.value && 1 == h.value.length && (q = h.value[0]) : q = h,
                                    q && q instanceof d.Variable)
                                        if (o.$char(":")) {
                                            if (k.length > 0 && (b && l("Cannot mix ; and , as delimiter types"),
                                            c = !0),
                                            g = a && n.detachedRuleset() || n.expression(),
                                            !g) {
                                                if (!a)
                                                    return o.restore(),
                                                    j.args = [],
                            ...
                            definition: function() {
                                ...
                                if (!("." !== o.currentChar() && "#" !== o.currentChar() || o.peek(/^[^{]*\}/)))
                                    ...
                                    b = o.$re(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)) {
                                        ...
                                        if (o.commentStore.length = 0,
                                        o.$re(/^when/) && (e = j(n.conditions, "expected condition")),
                                        c = n.block())
                                            return o.forget(),
                        ...
                        selector: function(a) {
                            for (var b, c, e, f, g, i, k, m = o.i; (a && (c = this.extend()) || a && (i = o.$re(/^when/)) || (f = this.element())) && (i ? k = j(this.conditions, "expected condition") : k ? l("CSS guard can only be used at the end of selector") : c ? g = g ? g.concat(c) : c : (g && l("Extend can only be used at the end of selector"),
                            e = o.currentChar(),
                            b ? b.push(f) : b = [f],
                            f = null),
                            "{" !== e && "}" !== e && ";" !== e && "," !== e && ")" !== e); )
                        ...
                        media: function() {
                            ...
                            o.$re(/^@media/) && (b = this.mediaFeatures(),
                            c = this.block()) ? (e = new d.Media(c,b,o.i,h),
                        ...
                        directive: function() {
                            ...
                            if ("@" === o.currentChar()) {
                                ...
                                b = o.$re(/^@[a-z-]+/)) {
                                    ...
                                    new d.Directive(b,c,e,k,h,a.dumpLineNumbers ? m(k) : null)) : void o.restore("directive options not recognised")
                                }
                            }
                        },
                        value: function() {
                        ...
                        sub: function() {
                            var a, b;
                            return o.$char("(") && (a = this.addition()) ? (b = new d.Expression([a]),
                            k(")"),
                            b.parens = !0,
                            b) : void 0
                        },
                        ...
                        condition: function() {
                            ...
                            k(")"),
                            o.$re(/^and/) ? new d.Condition("and",c,this.condition()) : c) : void 0
                        },
                        operand: function() {
            ...
            b.exports = function(a) {
                ...
                b.prototype.toCSS = function(b) {
                    ...
                    this._outputSourceFiles)
                        for (var c in this._contentsMap)
                            if (this._contentsMap.hasOwnProperty(c)) {
                                ...
                                this._contentsIgnoredCharsMap[c] && (d = d.slice(this._contentsIgnoredCharsMap[c])),
                                this._sourceMapGenerator.setSourceContent(this.normalizeFilename(c), d)
                            }
                    ...
                    this._css.length > 0) {
                        ...
                        this.sourceMapURL = e,
                        this._sourceMapFileInline ? e = "data:application/json;base64," + a.encodeBase64(f) : this.sourceMap = f,
        ...
        53: [function(a, b) {
            ...
            e.prototype.eval = function(a) {
                ...
                c && (c = c.eval(a),
                c.root = !0),
                new e(this.name,b,c,this.index,this.currentFileInfo,this.debugInfo)
            }
            ,
        ...
        57: [function(a, b) {
            ...
            i.prototype.genCSS = function(a, b) {
                this.css && (b.add("@import ", this.currentFileInfo, this.index),
        ...
        62: [function(a, b) {
            ...
            j.prototype.markReferenced = function() {
                ...
                for (this.rules[0].markReferenced(),
                this.isReferenced = !0,
                a = 0; a < b.length; a++)
                    b[a].markReferenced && b[a].markReferenced()
            }
            ...
            j.prototype.evalNested = function(a) {
                ...
                for (b = 0; b < f.length; b++)
                    e = f[b].features instanceof d ? f[b].features.value : f[b].features,
        ...
        64: [function(a, b) {
            ...
            i.prototype.evalParams = function(a, b, c, d) {
                ...
                if (b = new h.Eval(b,[q].concat(b.frames)),
                c)
                    for (c = c.slice(0),
                    s = c.length,
                    k = 0; s > k; k++)
        ...
        72: [function(a, b) {
            ...
            j.prototype.eval = function(a) {
                ...
                (n.root || n.allowImports || !n.strictImports) && n.evalImports(a);
                var q = n.rules
                  , r = q ? q.length : 0;
                for (f = 0; r > f; f++)
                    q[f].evalFirst && (q[f] = q[f].eval(a));
                var s = a.mediaBlocks && a.mediaBlocks.length || 0;
                for (f = 0; r > f; f++)
                    "MixinCall" === q[f].type ? (m = q[f].eval(a).filter(function(a) {
                        return a instanceof d && a.variable ? !n.variable(a.name) : !0
                    }),
                    q.splice.apply(q, [f, 1].concat(m)),
                    r += m.length - 1,
                    f += m.length - 1,
                    n.resetCache()) : "RulesetCall" === q[f].type && (m = q[f].eval(a).rules.filter(function(a) {
                ...
                for (f = 0; f < q.length; f++)
                    k = q[f],
                    k.evalFirst || (q[f] = k = k.eval ? k.eval(a) : k);
                for (f = 0; f < q.length; f++)
                    if (k = q[f],
                    k instanceof j && k.selectors && 1 === k.selectors.length && k.selectors[0].isJustParentSelector()) {
                        q.splice(f--, 1);
            ...
            j.prototype.genCSS = function(a, b) {
                ...
                for (d = 0; d < this.rules.length; d++)
                    h = this.rules[d],
                    c(h, this.root) ? m.push(h) : h.isCharset && h.isCharset() ? k.push(h) : l.push(h);
                if (l = k.concat(l),
                !this.root) {
                    g = i(a, this, p),
                    g && (b.add(g),
                ...
                for (d = 0; d < l.length; d++)
                    h = l[d],
                    d + 1 !== l.length || this.root && 0 !== m.length && !this.firstRoot || (a.lastRule = !0),
                    h.genCSS ? h.genCSS(a, b) : h.value && b.add(h.value.toString()),
                    a.lastRule ? a.lastRule = !1 : b.add(a.compress ? "" : "\n" + o);
                if (this.root || (b.add(a.compress ? "}" : "\n" + p + "}"),
                a.tabLevel--),
                n = (a.compress ? "" : "\n") + (this.root ? o : p),
                f = m.length)
                    for (l.length && n && b.add(n),
                    m[0].genCSS(a, b),
                    d = 1; f > d; d++)
                        n && b.add(n),
                        m[d].genCSS(a, b);
            ...
            j.prototype.joinSelector = function(a, b, c) {
                ...
                if (h) {
                    ...
                    d = 0; d < c.elements.length; d++)
                        ...
                        "&" !== j.value)
                            ...
                            e = 0; e < i.length; e++)
                                if (k = i[e],
                                0 === b.length)
                                    k.length > 0 && (k[0].elements = k[0].elements.slice(0),
                                    k[0].elements.push(new f(j.combinator,"",j.index,j.currentFileInfo))),
                                    s.push(k);
                                else
                                    for (g = 0; g < b.length; g++) {
                                        ...
                                        n = [],
                                        p = !0,
                                        k.length > 0 ? (m = k.slice(0),
                                        q = m.pop(),
                                        o = c.createDerived(q.elements.slice(0)),
                                        p = !1) : o = c.createDerived([]),
                                        l.length > 1 && (n = n.concat(l.slice(1))),
                                        l.length > 0) {
                                            p = !1;
                                            var t = j.combinator
                                              , u = l[0].elements[0];
                                            t.emptyOrWhitespace && !u.combinator.emptyOrWhitespace && (t = u.combinator),
                                            o.elements.push(new f(t,u.value,j.index,j.currentFileInfo)),
                    ...
                    for (r.length > 0 && this.mergeElementsOnToSelectors(r, i),
                    d = 0; d < i.length; d++)
        ...
        80: [function(a, b) {
            ...
            f.prototype = {
                run: function(a) {
                    var b = new e;
                    return b.run(a),
                    b.foundExtends ? (a.allExtends = a.allExtends.concat(this.doExtendChaining(a.allExtends, a.allExtends)),
                    this.allExtendsStack = [a.allExtends],
                    this._visitor.visit(a)) : a
                },
                doExtendChaining: function(a, b, d) {
                    ...
                    e = 0; e < a.length; e++)
                        for (f = 0; f < b.length; f++)
                            ...
                            g = n.findMatch(j, i),
                            g.length && j.selfSelectors.forEach(function(a) {
                ...
                extendSelector: function(a, b, d) {
                    ...
                    for (e = 0; e < a.length; e++)
                        ...
                        j++);
                    return j < b.length && k > 0 && (l[l.length - 1].elements = l[l.length - 1].elements.concat(b[j].elements.slice(k)),
                    j++),
        ...
        82: [function(a, b) {
            ...
            f.prototype = {
                ...
                onImported: function(a, b, c, d, e, f) {
                    ...
                    g.importCount--,
                    g.isFinished && (this._sequencer.tryRun(),
            ...
            e.prototype = {
                ...
                visitDirective: function(a) {
                    if (!a.currentFileInfo.reference || a.isReferenced) {
                        ...
                        return a.rules && a.rules.rules && this._mergeRules(a.rules.rules),
                        a
                    }
                },
